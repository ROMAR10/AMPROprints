  ...
  <div class="container" style="background-color: #fff;"> <!-- BODY COLOR -->
    ...
    <div class="row"> <!-- SEARCH & BUTTONS -->
      <div class="col-xl-4">  <!-- INPUT & SEARCH BTN -->
        <div class="input-group input-group-lg mb-3"> <!-- INPUT -->
          <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">AMP</span>
          </div>
      ...
      <div class="col-xl-2 offset-xl-6">
        <button type="button" data-toggle="modal" data-target="#DBCustomersAddModal" class="update btn btn-success btn-lg"><i class="fas fa-plus"></i> Add</button>
      </div> <!-- ADD BUTTON -->
    </div> <!-- SEARCH & BUTTONS -->
    ...
    <!-- MySQL TABLE -->
    <?php 
    include_once 'application/models/MySQL/selectCustomers.php';
    ?>
    <!-- MySQL TABLE -->
